...
const { register_users, login_users,updateUser, oneUser,getUser,landingpage, getallusers, forum_status,searchItems, landing_page } = require("../controller/users/users.controller")
